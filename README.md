...
<p style="color: white; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;" >Developed By:Ishwarya V</p>
<style>
...
## OUTPUT:
### Blank Canvas:
![output](blankcanvas1.png)

### Size Change:
![output](sizechange1.png)

### Drawn Canvas:
![output](drawncanvas1.png)
## Result:
